...
export interface BooleanLiteral extends langium.AstNode {
  readonly $container: JudgmentValue;
...
export type Declaration = ConceptDeclaration | JudgmentDeclaration | RecordDeclaration | Source;
...
export type Literal = BooleanLiteral | DateLiteral | NumberLiteral | StringLiteral | TruthLiteral;
