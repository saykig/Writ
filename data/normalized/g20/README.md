...
selections, compliance reports, and member compliance assessments. This directory is
documentation-only; the frozen Rio review copy lives under
...
`benchmark/2024-rio-g20/normalized/`. That copy contains 13 ingested political statements, 13
selections, two reports, 546 source-reported member judgments, one reconciliation record, and 15
review items. It records, rather than fills, the 161-commitment inventory gap.
