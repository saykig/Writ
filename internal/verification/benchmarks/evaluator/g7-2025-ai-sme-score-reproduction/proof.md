...
Run `bash internal/verification/fixtures/compatibility/g7-ai-sme/demo.sh` from a clean checkout to
reproduce every line below (the benchmark needs no
...
The internal `g7-ai-sme/language/2025-ai-sme-literal.writ` compatibility fixture compiles to an IR whose canonical hash is
...
```bash
bash internal/verification/fixtures/compatibility/g7-ai-sme/demo.sh
