...
def test_production_corpus_code_avoids_disallowed_label_term() -> None:
    ...
    production_paths = [
        ...
        root / "internal/tooling/scripts/discover_sources.py",
        root / "internal/tooling/scripts/fetch_sources.py",
        root / "internal/tooling/scripts/parse_commitments.py",
        root / "internal/tooling/scripts/parse_assessments.py",
        root / "internal/tooling/scripts/validate_corpus.py",
        root / "internal/tooling/scripts/build_benchmarks.py",
    ]
