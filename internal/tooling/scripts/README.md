...
- `discover_sources.py`, `fetch_sources.py`, `parse_assessments.py`, and `parse_commitments.py` are
  compatibility acquisition or preparation tools; running them may require explicit
