...
`conformance/` independently froze the expected behavior. Keeping executable semantics in both
...
validation-script, and documentation consumers. Use `conformance/cases/` as the portable semantic
