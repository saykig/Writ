...
Fixture excerpts under `corpora/multilateral/g20/2024-rio/sources/` contain only the cover, scoring-window,
Table 1, and Table 2 pages of the public reports; `sources/source-manifest.json` records the
full-source SHA-256 for each report. The frozen normalized record set is under
`corpora/multilateral/g20/2024-rio/records/`.
