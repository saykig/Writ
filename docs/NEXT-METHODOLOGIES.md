...
### 1. FATF Mutual Evaluations (AML/CFT) — *recommended*
...
- **Stresses:** the discrete ordinal / gap-overlap path at scale (40 items × a
  4-point scale, per country), plus an overall roll-up. Clean, public, unambiguous
  to source.
- **Independence:** high (a standing intergovernmental body; nothing to do with us).
- **Why recommended:** fully published ratings, a bounded rubric, a genuine
  soft-quantifier boundary, and an author we have no connection to. Lowest risk of
  "we graded our own encoding."
