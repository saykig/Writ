...
<!--
THESIS: A political-science and global-affairs research instrument whose sources, scope,
uncertainty, and derivations remain visible; it refuses the bright promotional SaaS dashboard.
OWN-WORLD: Near-black fields, white and grey type, restrained blue action, hairline borders, compact
...
- Interior routes begin with a small category label, a clear H1, and one research-facing sentence.
- Unknown and contested states must remain visually distinct from false, absent, or zero.
- Source-reported judgments and Writ-derived results must use distinct labels.
...
- Visualizations and memos are views. Their design must preserve links to the underlying records and
  must never imply that the rendered view is itself a source of truth.
- Corpus navigation must not encode a comparison question as the identity of a jurisdictional
  corpus.
